...
bool CCString::replace(std::string& str, const std::string& from, const std::string& to) {
...
void CCString::replaceAll(std::string& str, const std::string& from, const std::string& to) {
    if(from.empty())
        return;
    size_t start_pos = 0;
...
void CCString::replaceAll(const std::string& from, const std::string& to) {
    
    replaceAll(m_sString,from,to);
